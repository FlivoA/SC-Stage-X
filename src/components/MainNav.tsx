...
const NAV_LINKS = [
  ...
  },
  {
    ...
    label: 'Certification',
    children: [
      { id: 'certification/org-cert', label: 'Organizational Certification' },
      { id: 'certification/individual-cert', label: 'Individual Certification' },
      { id: 'certification/framework', label: 'Certification Framework' },
      { id: 'certification/eligibility', label: 'Eligibility Criteria' },
      { id: 'certification/apply', label: 'Apply for Certification' },
    ],
  },
  {
    id: 'standards',
    label: 'Standards',
    children: [
      { id: 'standards/governance', label: 'Security Governance Framework' },
      { id: 'standards/data-protection', label: 'Data Protection Standards' },
      { id: 'standards/secure-dev', label: 'Secure Development Guidelines' },
      { id: 'standards/compliance', label: 'Compliance Alignment' },
      { id: 'standards/methodology', label: 'Council Methodology' },
    ],
  },
  {
    id: 'about',
    ...
    children: [
      ...
      { id: 'about/governance-about', label: 'Governance' },
      { id: 'about/leadership', label: 'Leadership' },
      { id: 'about/members', label: 'Council Members' },
